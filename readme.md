...
│   │   │   └── webhook_dto.go           # Webhook request / response DTO
...
│   │   ├── payment_types.go             # Payment Input / Output structs
│   │   └── webhook_service.go           # Webhook event handling + merchant notify
│   │
│   ├── repository/
...
│   │
│   ├── httpx/
│   │   └── context.go                   # Gin context helpers (GetMerchantID, GetIdempotencyKey, ...)
│   │
│   ├── middleware/
...
│       ├── events.go                    # Event types + mock payload builder
│       └── README.md                    # How to run + available events
│
├── migrations/
│   ├── 000001_xxxxx.up.sql
│   └── 000001_xxxxx.down.sql
│
├── .env.example
├── .env.local
├── .air.toml
